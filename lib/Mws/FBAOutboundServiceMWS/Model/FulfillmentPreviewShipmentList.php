 ...
 * </ul>
 */
class Mws_FBAOutboundServiceMWS_Model_FulfillmentPreviewShipmentList extends Mws_FBAOutboundServiceMWS_Model
{


    /**
     * Construct new Mws_FBAOutboundServiceMWS_Model_FulfillmentPreviewShipmentList
     *
    ...
    {
        $this->_fields = array (
        'member' => array('FieldValue' => array(), 'FieldType' => array('Mws_FBAOutboundServiceMWS_Model_FulfillmentPreviewShipment')),
        );
     ...
     * @return Mws_FBAOutboundServiceMWS_Model_FulfillmentPreviewShipmentList  instance
     */
