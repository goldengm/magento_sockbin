 ...
 * </ul>
 */
class Mws_FBAOutboundServiceMWS_Model_GetFulfillmentOrderResult extends Mws_FBAOutboundServiceMWS_Model
{


    /**
     * Construct new Mws_FBAOutboundServiceMWS_Model_GetFulfillmentOrderResult
     *
    ...
    {
        $this->_fields = array (
        'FulfillmentOrder' => array('FieldValue' => null, 'FieldType' => 'Mws_FBAOutboundServiceMWS_Model_FulfillmentOrder'),
        'FulfillmentOrderItem' => array('FieldValue' => null, 'FieldType' => 'Mws_FBAOutboundServiceMWS_Model_FulfillmentOrderItemList'),
        'FulfillmentShipment' => array('FieldValue' => null, 'FieldType' => 'Mws_FBAOutboundServiceMWS_Model_FulfillmentShipmentList'),
        );
     ...
     *
     * @return Mws_FBAOutboundServiceMWS_Model_FulfillmentOrder FulfillmentOrder
     */
     ...
     *
     * @param FulfillmentOrder Mws_FBAOutboundServiceMWS_Model_FulfillmentOrder
     * @return void
     */
     ...
     *
     * @param Mws_FBAOutboundServiceMWS_Model_FulfillmentOrder $value FulfillmentOrder
     * @return Mws_FBAOutboundServiceMWS_Model_GetFulfillmentOrderResult instance
     */
     ...
     *
     * @return Mws_FBAOutboundServiceMWS_Model_FulfillmentOrderItemList FulfillmentOrderItem
     */
     ...
     *
     * @param FulfillmentOrderItemList Mws_FBAOutboundServiceMWS_Model_FulfillmentOrderItem
     * @return void
     */
     ...
     *
     * @param Mws_FBAOutboundServiceMWS_Model_FulfillmentOrderItemList $value FulfillmentOrderItem
     * @return Mws_FBAOutboundServiceMWS_Model_GetFulfillmentOrderResult instance
     */
     ...
     *
     * @return Mws_FBAOutboundServiceMWS_Model_FulfillmentShipmentList FulfillmentShipment
     */
     ...
     *
     * @param FulfillmentShipmentList Mws_FBAOutboundServiceMWS_Model_FulfillmentShipment
     * @return void
     */
     ...
     *
     * @param Mws_FBAOutboundServiceMWS_Model_FulfillmentShipmentList $value FulfillmentShipment
     * @return Mws_FBAOutboundServiceMWS_Model_GetFulfillmentOrderResult instance
     */
