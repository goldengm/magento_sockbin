 ...
 * </ul>
 */
class Mws_FBAOutboundServiceMWS_Model_CreateFulfillmentOrderResponse extends Mws_FBAOutboundServiceMWS_Model
{


    /**
     * Construct new Mws_FBAOutboundServiceMWS_Model_CreateFulfillmentOrderResponse
     *
    ...
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Mws_FBAOutboundServiceMWS_Model_CreateFulfillmentOrderResponse(($response->item(0)));
        } else {
            throw new Exception ("Unable to construct Mws_FBAOutboundServiceMWS_Model_CreateFulfillmentOrderResponse from provided XML.
     ...
     * @return Mws_FBAOutboundServiceMWS_Model_CreateFulfillmentOrderResponse instance
     */
