 ...
 * </ul>
 */
class Mws_FBAOutboundServiceMWS_Model_GetFulfillmentPreviewItemList extends Mws_FBAOutboundServiceMWS_Model
{


    /**
     * Construct new Mws_FBAOutboundServiceMWS_Model_GetFulfillmentPreviewItemList
     *
    ...
    {
        $this->_fields = array (
        'member' => array('FieldValue' => array(), 'FieldType' => array('Mws_FBAOutboundServiceMWS_Model_GetFulfillmentPreviewItem')),
        );
     ...
     * @return Mws_FBAOutboundServiceMWS_Model_GetFulfillmentPreviewItemList  instance
     */
