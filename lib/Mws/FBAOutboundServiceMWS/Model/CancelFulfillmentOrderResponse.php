 ...
 * </ul>
 */
class Mws_FBAOutboundServiceMWS_Model_CancelFulfillmentOrderResponse extends Mws_FBAOutboundServiceMWS_Model
{


    /**
     * Construct new Mws_FBAOutboundServiceMWS_Model_CancelFulfillmentOrderResponse
     *
     ...
     * @return Mws_FBAOutboundServiceMWS_Model_CancelFulfillmentOrderResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Mws_FBAOutboundServiceMWS_Model_CancelFulfillmentOrderResponse(($response->item(0)));
        } else {
            throw new Exception ("Unable to construct Mws_FBAOutboundServiceMWS_Model_CancelFulfillmentOrderResponse from provided XML.
     ...
     * @return Mws_FBAOutboundServiceMWS_Model_CancelFulfillmentOrderResponse instance
     */
