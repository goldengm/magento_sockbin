 ...
 * </ul>
 */
class Mws_FBAOutboundServiceMWS_Model_FulfillmentShipmentItemList extends Mws_FBAOutboundServiceMWS_Model
{


    /**
     * Construct new Mws_FBAOutboundServiceMWS_Model_FulfillmentShipmentItemList
     *
    ...
    {
        $this->_fields = array (
        'member' => array('FieldValue' => array(), 'FieldType' => array('Mws_FBAOutboundServiceMWS_Model_FulfillmentShipmentItem')),
        );
     ...
     *
     * @return Mws_FBAOutboundServiceMWS_Model_FulfillmentShipmentItem[]
     */
     ...
     * @return Mws_FBAOutboundServiceMWS_Model_FulfillmentShipmentItemList  instance
     */
