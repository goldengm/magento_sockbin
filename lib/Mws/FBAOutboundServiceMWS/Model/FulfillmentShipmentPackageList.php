 ...
 * </ul>
 */
class Mws_FBAOutboundServiceMWS_Model_FulfillmentShipmentPackageList extends Mws_FBAOutboundServiceMWS_Model
{


    /**
     * Construct new Mws_FBAOutboundServiceMWS_Model_FulfillmentShipmentPackageList
     *
    ...
    {
        $this->_fields = array (
        'member' => array('FieldValue' => array(), 'FieldType' => array('Mws_FBAOutboundServiceMWS_Model_FulfillmentShipmentPackage')),
        );
     ...
     *
     * @return Mws_FBAOutboundServiceMWS_Model_FulfillmentShipmentPackage[]
     */
     ...
     * @return Mws_FBAOutboundServiceMWS_Model_FulfillmentShipmentPackageList  instance
     */
