 ...
 * </ul>
 */
class Mws_FBAOutboundServiceMWS_Model_FulfillmentOrderList extends Mws_FBAOutboundServiceMWS_Model
{


    /**
     * Construct new Mws_FBAOutboundServiceMWS_Model_FulfillmentOrderList
     *
    ...
    {
        $this->_fields = array (
        'member' => array('FieldValue' => array(), 'FieldType' => array('Mws_FBAOutboundServiceMWS_Model_FulfillmentOrder')),
        );
     ...
     *
     * @return Mws_FBAOutboundServiceMWS_Model_FulfillmentOrder[] member
     */
     ...
     * @return Mws_FBAOutboundServiceMWS_Model_FulfillmentOrderList  instance
     */
