 ...
 * </ul>
 */
class Mws_FBAOutboundServiceMWS_Model_FulfillmentOrderItemList extends Mws_FBAOutboundServiceMWS_Model
{


    /**
     * Construct new Mws_FBAOutboundServiceMWS_Model_FulfillmentOrderItemList
     *
    ...
    {
        $this->_fields = array (
        'member' => array('FieldValue' => array(), 'FieldType' => array('Mws_FBAOutboundServiceMWS_Model_FulfillmentOrderItem')),
        );
     ...
     * @return Mws_FBAOutboundServiceMWS_Model_FulfillmentOrderItemList  instance
     */
