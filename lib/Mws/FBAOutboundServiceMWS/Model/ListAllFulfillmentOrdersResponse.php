 ...
 * </ul>
 */
class Mws_FBAOutboundServiceMWS_Model_ListAllFulfillmentOrdersResponse extends Mws_FBAOutboundServiceMWS_Model
{


    /**
     * Construct new Mws_FBAOutboundServiceMWS_Model_ListAllFulfillmentOrdersResponse
     *
    ...
    {
        $this->_fields = array (
        'ListAllFulfillmentOrdersResult' => array('FieldValue' => null, 'FieldType' => 'Mws_FBAOutboundServiceMWS_Model_ListAllFulfillmentOrdersResult'),
     ...
     * @return Mws_FBAOutboundServiceMWS_Model_ListAllFulfillmentOrdersResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Mws_FBAOutboundServiceMWS_Model_ListAllFulfillmentOrdersResponse(($response->item(0)));
        } else {
            throw new Exception ("Unable to construct Mws_FBAOutboundServiceMWS_Model_ListAllFulfillmentOrdersResponse from provided XML.
     ...
     *
     * @return Mws_FBAOutboundServiceMWS_Model_ListAllFulfillmentOrdersResult ListAllFulfillmentOrdersResult
     */
     ...
     *
     * @param ListAllFulfillmentOrdersResult  Mws_FBAOutboundServiceMWS_Model_ListAllFulfillmentOrdersResult
     * @return void
     */
     ...
     *
     * @param  Mws_FBAOutboundServiceMWS_Model_ListAllFulfillmentOrdersResult $value ListAllFulfillmentOrdersResult
     * @return Mws_FBAOutboundServiceMWS_Model_ListAllFulfillmentOrdersResponse instance
     */
