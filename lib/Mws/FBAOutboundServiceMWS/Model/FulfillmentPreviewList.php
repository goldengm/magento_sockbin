 ...
 * </ul>
 */
class Mws_FBAOutboundServiceMWS_Model_FulfillmentPreviewList extends Mws_FBAOutboundServiceMWS_Model
{


    /**
     * Construct new Mws_FBAOutboundServiceMWS_Model_FulfillmentPreviewList
     *
    ...
    {
        $this->_fields = array (
        'member' => array('FieldValue' => array(), 'FieldType' => array('Mws_FBAOutboundServiceMWS_Model_FulfillmentPreview')),
        );
     ...
     * @return Mws_FBAOutboundServiceMWS_Model_FulfillmentPreviewList  instance
     */
