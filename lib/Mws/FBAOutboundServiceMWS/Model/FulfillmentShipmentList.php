 ...
 * </ul>
 */
class Mws_FBAOutboundServiceMWS_Model_FulfillmentShipmentList extends Mws_FBAOutboundServiceMWS_Model
{


    /**
     * Construct new Mws_FBAOutboundServiceMWS_Model_FulfillmentShipmentList
     *
    ...
    {
        $this->_fields = array (
        'member' => array('FieldValue' => array(), 'FieldType' => array('Mws_FBAOutboundServiceMWS_Model_FulfillmentShipment')),
        );
     ...
     *
     * @return Mws_FBAOutboundServiceMWS_Model_FulfillmentShipment[]
     */
     ...
     * @return Mws_FBAOutboundServiceMWS_Model_FulfillmentShipmentList  instance
     */
