 ...
 * </ul>
 */
class Mws_FBAOutboundServiceMWS_Model_GetFulfillmentOrderResponse extends Mws_FBAOutboundServiceMWS_Model
{


    /**
     * Construct new Mws_FBAOutboundServiceMWS_Model_GetFulfillmentOrderResponse
     *
    ...
    {
        $this->_fields = array (
        'GetFulfillmentOrderResult' => array('FieldValue' => null, 'FieldType' => 'Mws_FBAOutboundServiceMWS_Model_GetFulfillmentOrderResult'),
     ...
     * @return Mws_FBAOutboundServiceMWS_Model_GetFulfillmentOrderResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Mws_FBAOutboundServiceMWS_Model_GetFulfillmentOrderResponse(($response->item(0)));
        } else {
            throw new Exception ("Unable to construct Mws_FBAOutboundServiceMWS_Model_GetFulfillmentOrderResponse from provided XML.
     ...
     *
     * @return Mws_FBAOutboundServiceMWS_Model_GetFulfillmentOrderResult GetFulfillmentOrderResult
     */
     ...
     *
     * @param GetFulfillmentOrderResult Mws_FBAOutboundServiceMWS_Model_GetFulfillmentOrderResult
     * @return void
     */
     ...
     *
     * @param Mws_FBAOutboundServiceMWS_Model_GetFulfillmentOrderResult $value GetFulfillmentOrderResult
     * @return Mws_FBAOutboundServiceMWS_Model_GetFulfillmentOrderResponse instance
     */
