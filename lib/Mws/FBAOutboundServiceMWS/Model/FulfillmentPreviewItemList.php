 ...
 * </ul>
 */
class Mws_FBAOutboundServiceMWS_Model_FulfillmentPreviewItemList extends Mws_FBAOutboundServiceMWS_Model
{


    /**
     * Construct new Mws_FBAOutboundServiceMWS_Model_FulfillmentPreviewItemList
     *
    ...
    {
        $this->_fields = array (
        'member' => array('FieldValue' => array(), 'FieldType' => array('Mws_FBAOutboundServiceMWS_Model_FulfillmentPreviewItem')),
        );
     ...
     * @return Mws_FBAOutboundServiceMWS_Model_FulfillmentPreviewItemList  instance
     */
