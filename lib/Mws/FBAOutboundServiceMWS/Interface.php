...
interface  Mws_FBAOutboundServiceMWS_Interface
{
     ...
     * @see Mws_FBAOutboundServiceMWS_Model_GetPackageTrackingDetailsRequest
     ...
     * @see Mws_FBAOutboundServiceMWS_Model_ListAllFulfillmentOrdersRequest
     ...
     * @see Mws_FBAOutboundServiceMWS_Model_GetFulfillmentPreviewRequest
     ...
     * @see Mws_FBAOutboundServiceMWS_Model_GetServiceStatusRequest
     ...
     * @see Mws_FBAOutboundServiceMWS_Model_ListAllFulfillmentOrdersByNextTokenRequest
     ...
     * @see Mws_FBAOutboundServiceMWS_Model_GetFulfillmentOrderRequest
     ...
     * @see Mws_FBAOutboundServiceMWS_Model_CancelFulfillmentOrderRequest
     ...
     * @see Mws_FBAOutboundServiceMWS_Model_CreateFulfillmentOrderRequest
