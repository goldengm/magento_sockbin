 ...
 * </ul>
 */
class Mws_FBAInboundServiceMWS_Model_InboundShipmentList extends Mws_FBAInboundServiceMWS_Model
{


    /**
     * Construct new Mws_FBAInboundServiceMWS_Model_InboundShipmentList
     *
    ...
    {
        $this->_fields = array (
        'member' => array('FieldValue' => array(), 'FieldType' => array('Mws_FBAInboundServiceMWS_Model_InboundShipmentInfo')),
        );
     ...
     * @return Mws_FBAInboundServiceMWS_Model_InboundShipmentList  instance
     */
