 ...
 * </ul>
 */
class Mws_FBAInboundServiceMWS_Model_InboundShipmentPlanList extends Mws_FBAInboundServiceMWS_Model
{


    /**
     * Construct new Mws_FBAInboundServiceMWS_Model_InboundShipmentPlanList
     *
    ...
    {
        $this->_fields = array (
        'member' => array('FieldValue' => array(), 'FieldType' => array('Mws_FBAInboundServiceMWS_Model_InboundShipmentPlan')),
        );
     ...
     * @return Mws_FBAInboundServiceMWS_Model_InboundShipmentPlanList  instance
     */
