 ...
 * </ul>
 */
class Mws_FBAInboundServiceMWS_Model_ListInboundShipmentsByNextTokenResult extends Mws_FBAInboundServiceMWS_Model
{


    /**
     * Construct new Mws_FBAInboundServiceMWS_Model_ListInboundShipmentsByNextTokenResult
     *
    ...
    {
        $this->_fields = array (
        'ShipmentData' => array('FieldValue' => null, 'FieldType' => 'Mws_FBAInboundServiceMWS_Model_InboundShipmentList'),
     ...
     * @return Mws_FBAInboundServiceMWS_Model_ListInboundShipmentsByNextTokenResult instance
     */
