 ...
 * </ul>
 */
class Mws_FBAInboundServiceMWS_Model_InboundShipmentPlanRequestItemList extends Mws_FBAInboundServiceMWS_Model
{


    /**
     * Construct new Mws_FBAInboundServiceMWS_Model_InboundShipmentPlanRequestItemList
     *
    ...
    {
        $this->_fields = array (
        'member' => array('FieldValue' => array(), 'FieldType' => array('Mws_FBAInboundServiceMWS_Model_InboundShipmentPlanRequestItem')),
        );
     ...
     *
     * @param Mws_FBAInboundServiceMWS_Model_InboundShipmentPlanRequestItem  $inboundShipmentPlanRequestItemArgs one or more member
     * @return Mws_FBAInboundServiceMWS_Model_InboundShipmentPlanRequestItemList  instance
     */
