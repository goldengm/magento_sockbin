 ...
 * </ul>
 */
class Mws_FBAInboundServiceMWS_Model_ErrorResponse extends Mws_FBAInboundServiceMWS_Model
{


    /**
     * Construct new Mws_FBAInboundServiceMWS_Model_ErrorResponse
     *
    ...
    {
        $this->_fields = array (
        'Error' => array('FieldValue' => array(), 'FieldType' => array('Mws_FBAInboundServiceMWS_Model_Error')),
     ...
     * @return Mws_FBAInboundServiceMWS_Model_ErrorResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Mws_FBAInboundServiceMWS_Model_ErrorResponse(($response->item(0)));
        } else {
            throw new Exception ("Unable to construct Mws_FBAInboundServiceMWS_Model_ErrorResponse from provided XML.
     ...
     * @return Mws_FBAInboundServiceMWS_Model_ErrorResponse  instance
     */
