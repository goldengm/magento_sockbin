 ...
 *
 */
class  Mws_FBAInventoryServiceMWS_Mock implements Mws_FBAInventoryServiceMWS_Interface
{
    // Public API ------------------------------------------------------------//
    ...
    public function listInventorySupplyByNextToken($request)
    {
        ...
        return Mws_FBAInventoryServiceMWS_Model_ListInventorySupplyByNextTokenResponse::fromXML($this->_invoke('ListInventorySupplyByNextToken'));
    }
    ...
    public function listInventorySupply($request)
    {
        ...
        return Mws_FBAInventoryServiceMWS_Model_ListInventorySupplyResponse::fromXML($this->_invoke('ListInventorySupply'));
    }
    ...
    public function getServiceStatus($request)
    {
        ...
        return Mws_FBAInventoryServiceMWS_Model_GetServiceStatusResponse::fromXML($this->_invoke('GetServiceStatus'));
    }
    ...
    {
        return $xml = file_get_contents('Mws/FBAInventoryServiceMWS/Mock/' . $actionName . 'Response.xml', /** search include path */ TRUE);
    }
}
