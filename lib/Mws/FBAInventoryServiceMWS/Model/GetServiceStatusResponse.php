 ...
 * </ul>
 */
class Mws_FBAInventoryServiceMWS_Model_GetServiceStatusResponse extends Mws_FBAInventoryServiceMWS_Model
{


    /**
     * Construct new Mws_FBAInventoryServiceMWS_Model_GetServiceStatusResponse
     *
    ...
    {
        $this->_fields = array (
        'GetServiceStatusResult' => array('FieldValue' => null, 'FieldType' => 'Mws_FBAInventoryServiceMWS_Model_GetServiceStatusResult'),
     ...
     * @return Mws_FBAInventoryServiceMWS_Model_GetServiceStatusResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Mws_FBAInventoryServiceMWS_Model_GetServiceStatusResponse(($response->item(0)));
        } else {
            throw new Exception ("Unable to construct Mws_FBAInventoryServiceMWS_Model_GetServiceStatusResponse from provided XML.
     ...
     *
     * @return Mws_FBAInventoryServiceMWS_Model_GetServiceStatusResult GetServiceStatusResult
     */
     ...
     * @return Mws_FBAInventoryServiceMWS_Model_GetServiceStatusResponse instance
     */
