 ...
 * </ul>
 */
class Mws_FBAInventoryServiceMWS_Model_InventorySupplyDetailList extends Mws_FBAInventoryServiceMWS_Model
{


    /**
     * Construct new Mws_FBAInventoryServiceMWS_Model_InventorySupplyDetailList
     *
    ...
    {
        $this->_fields = array (
        'member' => array('FieldValue' => array(), 'FieldType' => array('Mws_FBAInventoryServiceMWS_Model_InventorySupplyDetail')),
        );
     ...
     * @return Mws_FBAInventoryServiceMWS_Model_InventorySupplyDetailList  instance
     */
