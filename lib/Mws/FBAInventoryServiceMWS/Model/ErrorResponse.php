 ...
 * </ul>
 */
class Mws_FBAInventoryServiceMWS_Model_ErrorResponse extends Mws_FBAInventoryServiceMWS_Model
{


    /**
     * Construct new Mws_FBAInventoryServiceMWS_Model_ErrorResponse
     *
     ...
     * @return Mws_FBAInventoryServiceMWS_Model_ErrorResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Mws_FBAInventoryServiceMWS_Model_ErrorResponse(($response->item(0)));
        } else {
            throw new Exception ("Unable to construct Mws_FBAInventoryServiceMWS_Model_ErrorResponse from provided XML.
     ...
     * @return Mws_FBAInventoryServiceMWS_Model_ErrorResponse  instance
     */
