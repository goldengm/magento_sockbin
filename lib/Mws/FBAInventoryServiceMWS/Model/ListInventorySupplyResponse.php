 ...
 * </ul>
 */
class Mws_FBAInventoryServiceMWS_Model_ListInventorySupplyResponse extends Mws_FBAInventoryServiceMWS_Model
{


    /**
     * Construct new Mws_FBAInventoryServiceMWS_Model_ListInventorySupplyResponse
     *
    ...
    {
        $this->_fields = array (
        'ListInventorySupplyResult' => array('FieldValue' => null, 'FieldType' => 'Mws_FBAInventoryServiceMWS_Model_ListInventorySupplyResult'),
     ...
     * @return Mws_FBAInventoryServiceMWS_Model_ListInventorySupplyResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Mws_FBAInventoryServiceMWS_Model_ListInventorySupplyResponse(($response->item(0)));
        } else {
            throw new Exception ("Unable to construct Mws_FBAInventoryServiceMWS_Model_ListInventorySupplyResponse from provided XML.
     ...
     *
     * @return Mws_FBAInventoryServiceMWS_Model_ListInventorySupplyResult ListInventorySupplyResult
     */
     ...
     * @return Mws_FBAInventoryServiceMWS_Model_ListInventorySupplyResponse instance
     */
