 ...
 * </ul>
 */
class Mws_FBAInventoryServiceMWS_Model_ListInventorySupplyResult extends Mws_FBAInventoryServiceMWS_Model
{


    /**
     * Construct new Mws_FBAInventoryServiceMWS_Model_ListInventorySupplyResult
     *
    ...
    {
        $this->_fields = array (
        'InventorySupplyList' => array('FieldValue' => null, 'FieldType' => 'Mws_FBAInventoryServiceMWS_Model_InventorySupplyList'),
     ...
     *
     * @return Mws_FBAInventoryServiceMWS_Model_InventorySupplyList InventorySupplyList
     */
     ...
     * @return Mws_FBAInventoryServiceMWS_Model_ListInventorySupplyResult instance
     */
