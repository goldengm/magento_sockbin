 ...
 * </ul>
 */
class Mws_FBAInventoryServiceMWS_Model_ListInventorySupplyByNextTokenResponse extends Mws_FBAInventoryServiceMWS_Model
{


    /**
     * Construct new Mws_FBAInventoryServiceMWS_Model_ListInventorySupplyByNextTokenResponse
     *
    ...
    {
        $this->_fields = array (
        'ListInventorySupplyByNextTokenResult' => array('FieldValue' => null, 'FieldType' => 'Mws_FBAInventoryServiceMWS_Model_ListInventorySupplyByNextTokenResult'),
        'ResponseMetadata' => array('FieldValue' => null, 'FieldType' => 'Mws_FBAInventoryServiceMWS_Model_ResponseMetadata'),
        );
     ...
     * @return Mws_FBAInventoryServiceMWS_Model_ListInventorySupplyByNextTokenResponse
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new Mws_FBAInventoryServiceMWS_Model_ListInventorySupplyByNextTokenResponse(($response->item(0)));
        } else {
            throw new Exception ("Unable to construct Mws_FBAInventoryServiceMWS_Model_ListInventorySupplyByNextTokenResponse from provided XML.
     ...
     *
     * @return Mws_FBAInventoryServiceMWS_Model_ListInventorySupplyByNextTokenResult ListInventorySupplyByNextTokenResult
     */
     ...
     *
     * @param ListInventorySupplyByNextTokenResult Mws_FBAInventoryServiceMWS_Model_ListInventorySupplyByNextTokenResult
     * @return void
     */
     ...
     *
     * @param Mws_FBAInventoryServiceMWS_Model_ListInventorySupplyByNextTokenResult $value ListInventorySupplyByNextTokenResult
     * @return Mws_FBAInventoryServiceMWS_Model_ListInventorySupplyByNextTokenResponse instance
     */
     ...
     *
     * @return Mws_FBAInventoryServiceMWS_Model_ResponseMetadata ResponseMetadata
     */
     ...
     *
     * @param ResponseMetadata Mws_FBAInventoryServiceMWS_Model_ResponseMetadata
     * @return void
     */
     ...
     *
     * @param Mws_FBAInventoryServiceMWS_Model_ResponseMetadata $value ResponseMetadata
     * @return Mws_FBAInventoryServiceMWS_Model_ListInventorySupplyByNextTokenResponse instance
     */
