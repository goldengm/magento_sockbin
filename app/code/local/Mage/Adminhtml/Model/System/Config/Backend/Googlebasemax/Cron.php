 ...
 */
class Mage_Adminhtml_Model_System_Config_Backend_Googlebasemax_Cron extends Mage_Core_Model_Config_Data
{

    const CRON_STRING_PATH = 'crontab/jobs/googlebasemax_generate/schedule/cron_expr';
    const CRON_MODEL_PATH = 'crontab/jobs/googlebasemax_generate/run/model';
