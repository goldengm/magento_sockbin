...
class Mage_Adminhtml_Block_Catalog_Product_Helper_Form_Gallery_Content extends Mage_Adminhtml_Block_Widget
{
    ...
    {
        $productSkus = array();
        $parentSku = $this->getElement()->getDataObject()->getSku();
        $customOptions = $this->getElement()->getDataObject()->getProductOptionsCollection()->getItems();
        
        $productSkus[] = $parentSku;
        
        foreach ($customOptions as $customOption) {
            $customOptionValues = $customOption->getValues();
            foreach ($customOptionValues as $customOptionValue) {
                $valueData = $customOptionValue->getData();
                $productSkus[] = $valueData['sku'];
            }
        }
