...
/**
 * Googlebasemin resource catalog collection model
 *
 * @category    Sockbin
 * @package     Sockbin_Googlebasemin
 * @author      Magento Core Team <core@magentocommerce.com>
 */
abstract class Sockbin_Googlebasemin_Model_Resource_Catalog_Abstract extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
    ...
    protected function _prepareObject(array $row)
    {
        ...
        $entity->setPrice(strval(number_format($_product['price'], 2)));
