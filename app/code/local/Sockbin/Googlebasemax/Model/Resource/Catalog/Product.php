...
/**
 * Googlebasemax resource product collection model
 *
 * @category    Sockbin
 * @package     Sockbin_Googlebasemax
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Sockbin_Googlebasemax_Model_Resource_Catalog_Product extends Sockbin_Googlebasemax_Model_Resource_Catalog_Abstract
{
    /**
