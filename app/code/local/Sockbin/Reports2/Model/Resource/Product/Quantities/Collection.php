 ...
 */
class Sockbin_Reports2_Model_Resource_Product_Quantities_Collection extends Sockbin_Reports2_Model_Resource_Product_Collection
{
    /**
     ...
     * @var string
     */
    protected $_inventoryItemTableAlias    = 'quantities_inventory_item';
