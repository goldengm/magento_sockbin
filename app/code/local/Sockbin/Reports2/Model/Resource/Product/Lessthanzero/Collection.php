 ...
 */
class Sockbin_Reports2_Model_Resource_Product_Lessthanzero_Collection extends Sockbin_Reports2_Model_Resource_Product_Collection
{
    /**
     ...
     * @var string
     */
    protected $_inventoryItemTableAlias    = 'lessthanzero_inventory_item';
