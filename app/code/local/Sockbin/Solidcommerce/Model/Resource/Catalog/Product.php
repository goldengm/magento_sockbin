...
/**
 * Solidcommerce resource product collection model
 *
 * @category    Sockbin
 * @package     Sockbin_Solidcommerce
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Sockbin_Solidcommerce_Model_Resource_Catalog_Product extends Sockbin_Solidcommerce_Model_Resource_Catalog_Abstract
{
    /**
