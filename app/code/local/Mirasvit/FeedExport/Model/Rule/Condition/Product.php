...
class Mirasvit_FeedExport_Model_Rule_Condition_Product extends Mage_Rule_Model_Condition_Abstract
{
    ...
    protected function _addSpecialAttributes(array &$attributes)
    {
        $attributes = array_merge($attributes, array(
            'attribute_set_id' => Mage::helper('feedexport')->__('Attribute Set'),
            'category_ids'     => Mage::helper('feedexport')->__('Category'),
            'qty'              => Mage::helper('feedexport')->__('Quantity'),
            'type_id'          => Mage::helper('feedexport')->__('Product Type'),
            'image'            => Mage::helper('feedexport')->__('Base Image'),
            'thumbnail'        => Mage::helper('feedexport')->__('Thumbnail'),
            'small_image'      => Mage::helper('feedexport')->__('Small Image'),
            'image_size'       => Mage::helper('feedexport')->__('Base Image Size (bytes)'),
            'thumbnail_size'   => Mage::helper('feedexport')->__('Thumbnail Size (bytes)'),
            'small_image_size' => Mage::helper('feedexport')->__('Small Image Size (bytes)'),
            'php'              => Mage::helper('feedexport')->__('PHP Condition'),
            'is_in_stock'      => Mage::helper('feedexport')->__('Stock Availability'),
            'manage_stock'     => Mage::helper('feedexport')->__('Manage Stock'),
            'status_parent'    => Mage::helper('feedexport')->__('Status(Parent Product)'),
            'is_salable'       => Mage::helper('feedexport')->__('Is Salable'),
        ));
    }
