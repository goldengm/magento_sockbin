...
class Mirasvit_FeedExport_Block_Adminhtml_Feed_Edit_Tab_Ga extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $general = $form->addFieldset('general', array('legend' => Mage::helper('feedexport')->__('Google Analytics')));

        $general->addField('ga_source', 'text', array(
            'name'  => 'ga_source',
            'label' => Mage::helper('feedexport')->__('Campaign Source'),
        ...
        $general->addField('ga_medium', 'text', array(
            'name'  => 'ga_medium',
            'label' => Mage::helper('feedexport')->__('Campaign Medium'),
        ...
        $general->addField('ga_name', 'text', array(
            'name'  => 'ga_name',
            'label' => Mage::helper('feedexport')->__('Campaign Name'),
        ...
        $general->addField('ga_term', 'text', array(
            'name'  => 'ga_term',
            'label' => Mage::helper('feedexport')->__('Campaign Term'),
        ...
        $general->addField('ga_content', 'text', array(
            'name'  => 'ga_content',
            'label' => Mage::helper('feedexport')->__('Campaign Content'),
