    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    {
        return Mage::helper('feedexport')->__('Filters');
    }
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('conditions_fieldset', array('legend' => Mage::helper('feedexport')->__('Filters (leave blank for select all products)')))
