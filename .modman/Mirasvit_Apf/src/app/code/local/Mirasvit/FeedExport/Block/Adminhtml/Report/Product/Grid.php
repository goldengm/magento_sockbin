...
class Mirasvit_FeedExport_Block_Adminhtml_Report_Product_Grid extends Mage_Adminhtml_Block_Report_Grid_Abstract
{
    ...
    protected function _prepareColumns()
    {
        $this->addColumn('period', array(
            'header'          => Mage::helper('feedexport')->__('Period'),
            'index'           => 'period',
            'width'           => 100,
            'sortable'        => false,
            'period_type'     => $this->getPeriodType(),
            'renderer'        => 'adminhtml/report_sales_grid_column_renderer_date',
            'totals_label'    => Mage::helper('feedexport')->__('Total'),
            'subtotals_label' => Mage::helper('feedexport')->__('SubTotal'),
            'html_decorators' => array('nobr'),
        ));

        $this->addColumn('feed_id', array(
            'header'          => Mage::helper('feedexport')->__('Feed Id'),
            'index'           => 'feed_id',
            'width'           => 50,
            'sortable'        => false,
            'totals_label'    => '',
        ...
        $this->addColumn('product_sku', array(
            'header'          => Mage::helper('feedexport')->__('Product Sku'),
            'index'           => 'product_sku',
            'width'           => 100,
            'sortable'        => false,
            'totals_label'    => '',
        ...
        $this->addColumn('product_name', array(
            'header'          => Mage::helper('feedexport')->__('Product Name'),
            'index'           => 'product_name',
            'width'           => 100,
            'sortable'        => false,
            'totals_label'    => '',
        ...
        $this->addColumn('clicks', array(
            'header'    => Mage::helper('feedexport')->__('Number of Clicks'),
            'index'     => 'clicks',
            'type'      => 'number',
            'sortable'  => false
        ));
        ...
        $this->addColumn('orders', array(
            'header'   => Mage::helper('feedexport')->__('Number of Orders'),
            'index'    => 'orders',
            'type'     => 'number',
            'sortable' => false
        ));
        ...
        $this->addColumn('product_price', array(
            'header'          => Mage::helper('feedexport')->__('Product Price'),
            'index'           => 'product_price',
            'type'            => 'currency',
        ...
        $this->addColumn('revenue', array(
            'header'        => Mage::helper('feedexport')->__('Revenue'),
            'index'         => 'revenue',
            'type'          => 'currency',
            'sortable'      => false,
            'currency_code' => $currencyCode,
