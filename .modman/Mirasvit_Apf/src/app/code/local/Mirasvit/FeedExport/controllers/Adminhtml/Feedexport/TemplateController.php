...
class Mirasvit_FeedExport_Adminhtml_Feedexport_TemplateController extends Mage_Adminhtml_Controller_Action
{
    protected function _initAction()
    {
        $this->loadLayout()
            ...
            ->_title(Mage::helper('feedexport')->__('Templates'));
    ...
    public function editAction()
    {
        ...
        $this->_title($id ? $model->getName() : Mage::helper('feedexport')->__('New Template'));
        $this->_initAction();
    ...
    public function saveAction()
    {
        if ($data = $this->getRequest()->getPost()) {
            ...
            try {
                ...
                Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('feedexport')->__('Template was successfully saved'));
    ...
    public function deleteAction()
    {
        try {
            ...
            Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('feedexport')->__('Template was successfully deleted'));
        } catch (Exception $e) {
            Mage::getSingleton('adminhtml/session')->addError($e->getMessage());
            $this->_redirect('*/*/edit', array('id' => $this->getRequest()->getParam('id')));
    ...
    public function doimportAction()
    {
        if ($data = $this->getRequest()->getPost()) {
            foreach ($data['template'] as $template) {
                ...
                Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('feedexport')->__('Template %s imported', $model->getName()));
            }
        }
    ...
    public function exportAction()
    {
        ...
        Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('feedexport')->__('Template exported to %s', $path));
        $this->_redirect('*/*/');
    }
