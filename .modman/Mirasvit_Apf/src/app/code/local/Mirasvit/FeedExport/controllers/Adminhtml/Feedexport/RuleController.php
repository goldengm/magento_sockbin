...
class Mirasvit_FeedExport_Adminhtml_Feedexport_RuleController extends Mage_Adminhtml_Controller_Action
{
    protected function _initAction()
    {
        if ($this->getRequest()->getParam('popup')) {
            ...
            $this->loadLayout()
                ...
                ->_title(Mage::helper('feedexport')->__('Filters'));
        }
    ...
    public function editAction()
    {
        ...
        $this->_title($id ? $model->getName() : Mage::helper('feedexport')->__('New Filter'));
        $this->_initAction();
    ...
    public function saveAction()
    {
        if ($data = $this->getRequest()->getPost()) {
            ...
            try {
                ...
                Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('feedexport')->__('Filter was successfully saved'));
    ...
    public function exportAction()
    {
        ...
        Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('feedexport')->__('Filter rule exported to %s', $path));
